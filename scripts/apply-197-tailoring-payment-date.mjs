#!/usr/bin/env node
// Aplica la migración 197: añade columna payment_date (DATE, nullable) a tailoring_orders.
...
const sqlPath = resolve(__dirname, '..', 'supabase', 'migrations', '197_tailoring_order_payment_date.sql')
...
if (res.ok) {
  console.log('✔ Migración 197 aplicada. tailoring_orders.payment_date añadido.')
  process.exit(0)
}
