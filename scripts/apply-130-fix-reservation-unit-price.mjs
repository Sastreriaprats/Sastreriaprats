#!/usr/bin/env node
// Aplica la migración 130: fix rpc_create_reservation para no pasar
// NULL en product_reservations.unit_price (NOT NULL).
//
...
const sqlPath = resolve(__dirname, '..', 'supabase', 'migrations', '130_fix_rpc_create_reservation_unit_price.sql')
...
if (res.ok) {
  console.log('✔ Migración 130 aplicada. rpc_create_reservation ya no inserta NULL en unit_price.')
  process.exit(0)
}
