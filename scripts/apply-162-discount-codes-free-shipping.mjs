#!/usr/bin/env node
// Aplica la migración 162: añade columna free_shipping a discount_codes.
...
const sqlPath = resolve(__dirname, '..', 'supabase', 'migrations', '162_discount_codes_free_shipping.sql')
...
if (res.ok) {
  console.log('✔ Migración 162 aplicada. discount_codes.free_shipping añadido.')
  process.exit(0)
}
