...
import { OfficialsLoadTable } from '@/components/officials/officials-load-table'

export const metadata = { title: 'Oficiales · Sastre' }

export default async function SastreOficialesPage() {
  ...
  return (
    <SastreLayoutWithSidebar sastreName={sastreName} isSastrePlus={isSastrePlus}>
      <div className="px-6 py-6 space-y-4">
        <h1 className="text-2xl font-bold tracking-tight text-white">Oficiales</h1>
        <OfficialsLoadTable basePath="/sastre" />
      </div>
