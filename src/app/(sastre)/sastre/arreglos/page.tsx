...
import { ArreglosContent } from './arreglos-content'

export const metadata = { title: 'Arreglos · Sastre' }

export default async function SastreArreglosPage() {
  ...
  return (
    <SastreLayoutWithSidebar sastreName={sastreName} isSastrePlus={isSastrePlus}>
      <ArreglosContent sastreName={sastreName} />
