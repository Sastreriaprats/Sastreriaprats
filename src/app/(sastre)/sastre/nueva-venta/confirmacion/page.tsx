...
import { NuevaVentaConfirmacionClient } from './nueva-venta-confirmacion-client'

export const metadata = { title: 'Nueva venta — Confirmación · Sastre' }
export const dynamic = 'force-dynamic'

export default async function NewVentaConfirmacionPage({
  searchParams,
}: {
  ...
  return (
    <SastreLayoutWithSidebar sastreName={sastreName}>
      <NuevaVentaConfirmacionClient orderId={orderId ?? ''} />
