            ...
            <CardContent className="space-y-4">
              ...
              {!isEdit && showAddVariant && (
                <div className="rounded-lg border p-4 space-y-3 bg-muted/30">
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" onClick={addVariant} disabled={!variantForm.variant_sku.trim() && !computeVariantSku} className="bg-prats-navy hover:bg-prats-navy-light">
                      Añadir
                    </Button>
