...
export const clients = pgTable('clients', {
  ...
  optInTokenCreatedAt: timestamp('opt_in_token_created_at', { withTimezone: true }),
  optInSentAt: timestamp('opt_in_sent_at', { withTimezone: true }),
...
export const stockTransfers = pgTable('stock_transfers', {
  ...
  destinationApprovedBy: uuid('destination_approved_by').references(() => profiles.id, { onDelete: 'set null' }),
  destinationApprovedAt: timestamp('destination_approved_at', { withTimezone: true }),
  receivedBy: uuid('received_by').references(() => profiles.id, { onDelete: 'set null' }),
  receivedAt: timestamp('received_at', { withTimezone: true }),
  notes: text('notes'),
  createdAt: timestamp('created_at', { withTimezone: true }).defaultNow().notNull(),
