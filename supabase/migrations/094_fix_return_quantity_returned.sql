-- ============================================================
-- Migration 094: rpc_create_return usa quantity_returned (no is_returned)
-- La columna is_returned nunca existió en sale_lines; el tracking real
-- es quantity_returned (integer) + returned_at + return_reason.
-- ============================================================
...
BEGIN
  ...
  --    y que NO han sido devueltas previamente
  ...
  -- 6. Mark selected lines as returned (cantidad completa de la línea)
  UPDATE sale_lines
  ...
  -- 7. Check if all lines of the sale are now fully returned
  SELECT NOT EXISTS (
