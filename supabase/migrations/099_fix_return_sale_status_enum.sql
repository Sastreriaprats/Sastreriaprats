-- ============================================================
-- Migration 099: rpc_create_return — valores correctos del enum sale_status
-- El enum es ('completed','partially_returned','fully_returned','voided').
-- La 098 asignaba 'returned' / 'partial_return' (inexistentes) y sin cast.
-- ============================================================
