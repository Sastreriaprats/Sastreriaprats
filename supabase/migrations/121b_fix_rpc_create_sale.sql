-- ============================================================
-- Migration 121: Reaplicar rpc_create_sale con salesperson_id
-- y soporte completo de reservation_line_id
--
-- La función instalada en el DB actual usa `cashier_id`, columna
-- que ya no existe en la tabla `sales`, por lo que cualquier venta
-- TPV falla con "column ... does not exist". Extrae únicamente la
-- definición de rpc_create_sale de la migración 112b.
-- ============================================================
