-- ============================================================
-- Migration 138: rpc_create_return — incrementa sales.total_returned
-- Cada vez que se crea una devolución, además de marcar status, reponer
-- stock y actualizar la sesión de caja, sumamos v_total_returned al
-- nuevo cache sales.total_returned (introducido en la 137).
-- Resto del comportamiento idéntico a la 136.
-- ============================================================
