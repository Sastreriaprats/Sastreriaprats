-- ============================================================
-- Migration 104: rpc_create_sale con integración de reservas
-- Reemplaza la versión 092 añadiendo:
--   a) Consumo FIFO de reservas activas del mismo cliente antes
--      de descontar stock libre (auto-fulfill).
--   b) Validación: no permite vender stock que esté reservado
--      para otros clientes (bloquea si available < qty).
-- ============================================================
...
BEGIN
  ...
  -- 9. Stock con integración de reservas
  ...
  IF v_warehouse_id IS NOT NULL THEN
    ...
    LOOP
      ...
      -- 9a. Consumir reservas activas del mismo cliente (FIFO)
      ...
      -- 9b. Stock libre restante: valida disponibilidad (respeta reservas ajenas)
