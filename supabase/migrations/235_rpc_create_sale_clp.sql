-- ============================================================
-- Migración 235 — rpc_create_sale + serie interna CLP
--
-- CREATE OR REPLACE partiendo de la definición VIVA (migración 209). Único
-- cambio respecto a 209: bloque 6b que asigna la ref CLP (E si el cobro es
-- 100% efectivo; T en cualquier otro caso) y la añade al JSON de retorno.
-- Cubre también el "Cambio directo" (rpc_process_exchange reutiliza esta RPC;
-- siempre lleva vale => serie T).
-- ============================================================
